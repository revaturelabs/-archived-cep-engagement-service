 ...
 */
@RestController
@CrossOrigin(origins={ "http://localhost:3000", "http://localhost:4200", "http://localhost:8081", "http://ec2-3-229-134-85.compute-1.amazonaws.com:9015"}) //CORS will be changed to EC2 servers
